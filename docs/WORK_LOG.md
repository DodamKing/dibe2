...
### 2026-07-17 - 크론 타임아웃 방어 + 장르 크론 신설, 적재 전 발견한 문제 3건 (⚠️ 적재 미완 — 여기서 재개)

> **다음 세션 재개 지점.** 크롤링 데이터는 `data/`에 다 있고 DB는 아직 **한 글자도 안 건드렸다.**
> 아래 "남은 일"의 순서를 반드시 지킬 것 — DB를 먼저 안 고치면 중복이 박힌다.
...
| `songs-enriched.jsonl` | **약 6,400곡** 장르/스타일 (장르 99.9%, 스타일 100%) |
